 ...
 *|---+---+---+---|
 */
[_LAYER_1] = LAYOUT_numpad( \
    RGB_MOD,  RGB_M_SW, RGB_M_P,  KC_MUTE,
    KC_7,     KC_8,     KC_9,     LT(_LAYER_2,KC_BSPC),
    KC_4,     KC_5,     KC_6,
    KC_1,     KC_2,     KC_3,     KC_ENT,
    KC_0,     KC_DOT,
    KC_MRWD,  KC_MFFD,  KC_VOLD,  KC_VOLU
),
/* _LAYER_2
 *|---------------|
 *|F24| / | * | - |
...
[_LAYER_2] = LAYOUT_numpad( \
    KC_F24,    KC_PSLS,   KC_PAST,   KC_PMNS,
    KC_HOME,   KC_UP,     KC_PGUP,   KC_PPLS,
    KC_LEFT,   KC_DOWN,   KC_RGHT,
    KC_END,    XXXXXXX,   KC_PGDN,   KC_PPLS,
    XXXXXXX,   KC_DEL,
    XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX
),

[_LAYER_3] = LAYOUT_numpad( \
    XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,
    XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,
...
bool encoder_update_user(uint8_t index, bool clockwise){
  ...
  if(index==0){//一つ目のエンコーダ
    if(clockwise){//時計回りに回したとき、
      key.row=5,key.col=2;//[5,2]のキー
    }else{
      key.row=5,key.col=3;//[5,3]のキー
    }
    tap_code(keymap_key_to_keycode(layer_switch_get_layer(key),key));
  }
  if(index==1){//二つ目のエンコーダ
    if(clockwise){//時計回りに回したとき、
      key.row=5,key.col=0;//[5,0]のキー
    }else{
      key.row=5,key.col=1;//[5,1]のキー
    }
    tap_code(keymap_key_to_keycode(layer_switch_get_layer(key),key));
  }
  return false;
...
sethsv(0, 0, 255, (LED_TYPE *)&led[7]);
sethsv(0, 0, 255, (LED_TYPE *)&led[8]);
...
sethsv(0, 0, 255, (LED_TYPE *)&led[19]);
sethsv(0, 0, 255, (LED_TYPE *)&led[20]);
sethsv(0, 0, 255, (LED_TYPE *)&led[21]);
sethsv(0, 0, 255, (LED_TYPE *)&led[22]);
sethsv(0, 0, 255, (LED_TYPE *)&led[23]);
sethsv(0, 0, 255, (LED_TYPE *)&led[24]);
sethsv(0, 0, 255, (LED_TYPE *)&led[25]);
...
sethsv(0, 0, 0, (LED_TYPE *)&led[32]);
sethsv(0, 0, 0, (LED_TYPE *)&led[33]);
sethsv(0, 0, 0, (LED_TYPE *)&led[34]);
sethsv(0, 0, 255, (LED_TYPE *)&led[35]);
sethsv(0, 0, 0, (LED_TYPE *)&led[36]);
sethsv(0, 0, 0, (LED_TYPE *)&led[37]);
sethsv(0, 0, 255, (LED_TYPE *)&led[38]);
sethsv(0, 0, 0, (LED_TYPE *)&led[39]);
sethsv(0, 0, 0, (LED_TYPE *)&led[40]);
sethsv(0, 0, 255, (LED_TYPE *)&led[41]);
sethsv(0, 0, 0, (LED_TYPE *)&led[42]);
sethsv(0, 0, 0, (LED_TYPE *)&led[43]);
sethsv(0, 0, 0, (LED_TYPE *)&led[44]);
sethsv(0, 0, 0, (LED_TYPE *)&led[45]);
sethsv(0, 0, 0, (LED_TYPE *)&led[46]);
sethsv(0, 0, 0, (LED_TYPE *)&led[47]);
sethsv(0, 0, 0, (LED_TYPE *)&led[48]);
sethsv(0, 0, 0, (LED_TYPE *)&led[49]);
sethsv(0, 0, 0, (LED_TYPE *)&led[50]);
sethsv(0, 0, 255, (LED_TYPE *)&led[51]);
sethsv(0, 255, 200, (LED_TYPE *)&led[52]);
sethsv(0, 0, 0, (LED_TYPE *)&led[53]);
sethsv(0, 0, 255, (LED_TYPE *)&led[54]);
sethsv(0, 255, 200, (LED_TYPE *)&led[55]);
sethsv(0, 0, 0, (LED_TYPE *)&led[56]);
sethsv(0, 0, 255, (LED_TYPE *)&led[57]);
...
sethsv(0, 0, 0, (LED_TYPE *)&led[66]);
sethsv(0, 0, 255, (LED_TYPE *)&led[67]);
sethsv(0, 0, 255, (LED_TYPE *)&led[68]);
sethsv(0, 0, 255, (LED_TYPE *)&led[69]);
sethsv(0, 0, 255, (LED_TYPE *)&led[70]);
sethsv(0, 0, 255, (LED_TYPE *)&led[71]);
sethsv(0, 0, 255, (LED_TYPE *)&led[72]);
sethsv(0, 0, 255, (LED_TYPE *)&led[73]);
sethsv(0, 0, 0, (LED_TYPE *)&led[74]);
sethsv(0, 0, 0, (LED_TYPE *)&led[75]);
sethsv(0, 0, 0, (LED_TYPE *)&led[76]);
sethsv(0, 0, 0, (LED_TYPE *)&led[77]);
sethsv(0, 0, 0, (LED_TYPE *)&led[78]);
sethsv(0, 0, 0, (LED_TYPE *)&led[79]);
sethsv(0, 0, 0, (LED_TYPE *)&led[80]);
sethsv(0, 0, 0, (LED_TYPE *)&led[81]);
sethsv(0, 0, 0, (LED_TYPE *)&led[82]);
sethsv(0, 0, 0, (LED_TYPE *)&led[83]);
sethsv(0, 0, 255, (LED_TYPE *)&led[84]);
...
sethsv(0, 0, 0, (LED_TYPE *)&led[94]);
sethsv(0, 0, 0, (LED_TYPE *)&led[95]);
sethsv(0, 0, 0, (LED_TYPE *)&led[96]);
sethsv(0, 0, 0, (LED_TYPE *)&led[97]);
sethsv(0, 0, 0, (LED_TYPE *)&led[98]);
sethsv(0, 0, 0, (LED_TYPE *)&led[99]);
sethsv(0, 0, 255, (LED_TYPE *)&led[100]);
sethsv(0, 0, 0, (LED_TYPE *)&led[101]);
...
sethsv(0, 0, 0, (LED_TYPE *)&led[52]);
sethsv(0, 0, 0, (LED_TYPE *)&led[53]);
sethsv(0, 0, 255, (LED_TYPE *)&led[54]);
sethsv(0, 0, 0, (LED_TYPE *)&led[55]);
sethsv(0, 255, 200, (LED_TYPE *)&led[56]);
sethsv(0, 0, 255, (LED_TYPE *)&led[57]);
sethsv(0, 0, 0, (LED_TYPE *)&led[58]);
sethsv(0, 255, 200, (LED_TYPE *)&led[59]);
...
sethsv(0, 0, 0, (LED_TYPE *)&led[68]);
sethsv(0, 0, 0, (LED_TYPE *)&led[69]);
sethsv(0, 0, 255, (LED_TYPE *)&led[70]);
sethsv(0, 0, 255, (LED_TYPE *)&led[71]);
sethsv(0, 0, 255, (LED_TYPE *)&led[72]);
sethsv(0, 0, 255, (LED_TYPE *)&led[73]);
sethsv(0, 0, 255, (LED_TYPE *)&led[74]);
sethsv(0, 0, 255, (LED_TYPE *)&led[75]);
sethsv(0, 0, 255, (LED_TYPE *)&led[76]);
sethsv(0, 0, 0, (LED_TYPE *)&led[77]);
sethsv(0, 0, 0, (LED_TYPE *)&led[78]);
sethsv(0, 0, 0, (LED_TYPE *)&led[79]);
sethsv(0, 0, 0, (LED_TYPE *)&led[80]);
...
sethsv(0, 0, 0, (LED_TYPE *)&led[85]);
sethsv(0, 0, 0, (LED_TYPE *)&led[86]);
sethsv(0, 0, 255, (LED_TYPE *)&led[87]);
sethsv(0, 0, 255, (LED_TYPE *)&led[88]);
sethsv(0, 0, 255, (LED_TYPE *)&led[89]);
sethsv(0, 0, 255, (LED_TYPE *)&led[90]);
sethsv(0, 0, 255, (LED_TYPE *)&led[91]);
sethsv(0, 0, 0, (LED_TYPE *)&led[92]);
sethsv(0, 0, 0, (LED_TYPE *)&led[93]);
sethsv(0, 0, 0, (LED_TYPE *)&led[94]);
sethsv(0, 0, 0, (LED_TYPE *)&led[95]);
